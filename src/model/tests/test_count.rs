...
// Creating a new Count with an empty name field should return a Count object
// with an empty debtor field.
#[test]
...
// Calling pay_all() on a Count object with installments > 0 should set the
// paid_installments field to the same value as the installments field and set
// the status field to true.
#[test]
fn test_pay_all() {
    let mut count = Count::from(
        "John Doe",
...
// Calling pay() on a Count object with installments > 0 and paid_installments <
// installments should increment the paid_installments field by 1.
#[test]
fn test_pay() {
    let mut count = Count::from(
        "John Doe",
...
// Calling pay() on a Count object with installments > 0 and paid_installments
// == installments - 1 should set the paid_installments field to the same value
// as the installments field and set the status field to true.
#[test]
...
// Creating a new Count with a non-alphanumeric name field should return a Count
// object with an empty debtor field.
#[test]
...
// Creating a new Count with an empty title field should return a Count object
...
// Creating a new Count with a value of 0.0 should return a Count object with a
// value field of 0.0.
#[test]
...
// Calling pay() on a Count object with installments == 0 should not change the
// paid_installments or status fields.
#[test]
...
// Calling is_empty() on a Count object with an empty name field should return
// true.
#[test]
...
// Calling is_empty() on a Count object with a non-alphanumeric name field
// should return true.
#[test]
...
// Calling is_empty() on a Count object with an empty title field should return
// true.
#[test]
...
// Calling to_string() on a Count object should return a string representation
// of the object in the format "id, debtor, title, description, value, date_in,
// date_out, paid_installments, installments, nature, status".
#[test]
fn test_to_string() {
    let count = Count {
        id: 0,
