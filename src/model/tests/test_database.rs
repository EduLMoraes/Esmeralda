...
// The 'new' function successfully creates a new instance of the 'DataBase'
// struct.
#[tokio::test]
...
// The 'get' function successfully retrieves counts for a specific user and year
// from the database.
#[tokio::test]
...
// The 'get' function successfully retrieves years with counts for a specific
...
// The 'new' function handles the case where the database connection fails and
...
// The 'add' function handles the case where the data type is invalid and
// returns an error.
#[tokio::test]
...
// The 'get' function handles the case where the data type is invalid and
// returns an error.
#[tokio::test]
...
// The 'edit' function handles the case where the data type is invalid and
// returns an error.
#[tokio::test]
...
// The 'edit' function successfully updates counts for a specific user in the
// database.
#[tokio::test]
...
// The 'edit' function successfully updates the password for a specific user in
// the database.
#[tokio::test]
...
// The 'get' function handles the case where the user is not found in the
// database.
#[tokio::test]
...
// The 'get' function handles the case where there are no counts for a specific
// user and year in the database.
#[tokio::test]
