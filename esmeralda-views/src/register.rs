        ...
        ui.vertical_centered(|ui| {
            ...
            egui::Frame::new()
                ...
                .show(ui, |ui| {
                    ...
                    // Campo E-mail
                    ui.label("E-mail");
                    ui.add(egui::TextEdit::singleline(&mut self.email)
                    ...
                    if let Some(error) = &self.error_msg {
                        ui.add_space(10.0);
                        ui.label(egui::RichText::new(error).color(egui::Color32::LIGHT_RED).small());
                    }

                    ui.add_space(25.0);

                    // Botão Criar Conta
                    let btn_register = egui::Button::new(egui::RichText::new("Criar Conta Esmeralda").strong())
